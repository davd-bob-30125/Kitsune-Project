...
namespace Kitsune.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Login(User user)
        {
            ...
            var matchingUser = _context.User.SingleOrDefault(u => u.Name == user.Name && u.Password == user.Password);

            if (matchingUser != null)
            {
                // TO DO account page
                // Successful login, redirect to account page
                return RedirectToAction( "Details", "Users", new { id = matchingUser.Id });
            }
            else
            {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Password,Balance")] User user)
        {
